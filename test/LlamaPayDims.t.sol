...
contract PayerTest is Test {
    ...
    function testFullFlow() public {
        ...
        console.log("  Contract token balance:", token.balanceOf(address(payContract)));
        ...
        console.log("  Total expected payee balance:", firstWithdrawalAmount + secondWithdrawalAmount);
        console.log("  Payee token balance:", token.balanceOf(payee));
        ...
        console.log("  Payer's total streaming rate:", payContract.totalPaidPerSec(payer));
        console.log("  Payer remaining principal after cancelling stream:", payContract.balances(payer));
        console.log("  Contract token balance:", token.balanceOf(address(payContract)));
        ...
        console.log("=== Step 6: Payer Withdraws Remaining Funds (after withdraw payer) ===");
        console.log("  Payer token balance:", token.balanceOf(payer));
        console.log("  Contract token balance:", token.balanceOf(address(payContract)));
        console.log("  Payer remaining principal:", payContract.balances(payer));
    ...
    function testDeposit() public {
        ...
        assertEq(afterDepositContractBalance - initialContractBalance, 10_000 * 1e6);
        vm.stopPrank();
    }
