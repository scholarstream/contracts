...
contract ScholarStreamFactory {
    ...
    function createPayContract(address _token) external returns (ScholarStream newContract) {
    ...
    function getPayContract(address _token) external view returns (ScholarStream) {
